...
namespace LUANVANTOTNGHIEP_VODUCANKHANG.Helper
{
    public class Utilities
    {
        ...
        public static string GetRandomKey(int length = 10)
        {
            //chuỗi mẫu (pattern)
        ...
        public static string GetRandomResetPassword(int length = 7)
        {
            //chuỗi mẫu (pattern)
            string pattern = @"QWERTYUIOPASDFGHJKLZXCVBNM0123456789zxcvbnmasdfghjklqwertyuiop!@#$%&";
            Random rd = new Random();
            StringBuilder sb = new StringBuilder();
        ...
        public static string GetRandomIdNumberOrder(int length = 10)
        {
            //chuỗi mẫu (pattern)
        ...
        internal static string SEOUrl(object tensanpham)
        {
